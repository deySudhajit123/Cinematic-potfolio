...
export default function WorkExperienceSection() {
  ...
  // (collapsedHeights no longer needed — bullets now scroll internally)
  ...
  function handleCardEnter(i) {
    ...
    // Only animate border + dot glow — no height expansion (bullets scroll internally)
    tl.to(ul,  { borderLeftColor: 'rgba(247,147,30,0.6)', duration: 0.3 }, 0)
  ...
  function handleCardLeave(i) {
    ...
    const tl = gsap.timeline()
    hoverTlsRef.current[i] = tl
    tl.to(ul,  { borderLeftColor: 'rgba(247,147,30,0.2)', duration: 0.25 }, 0)
